# nvim-treesitter-queries-jjdescription

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-jjdescription/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-jjdescription/actions/workflows/validate.yml)

Neovim tree-sitter queries for **jjdescription**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-jjdescription",
...
- [ ] Changes are scoped to `jjdescription` — do not include files for other languages
